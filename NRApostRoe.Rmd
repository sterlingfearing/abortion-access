...
# load files
postRoe <- read_csv("code/data/NRApostRoe.csv")
preRoe <- st_read("code/data/NRAcounty.shp")

# join
NRA <- full_join(preRoe, postRoe, by= "GEOID")

# clean
NRA <- NRA %>%
  select("GEOID", "stateFIPS.x", "countyFIPS.x", "county.x", "minDist_mi.x", "minDist_mi.y", "geometry.x") 
...
write_sf(NRA, "code/data/compareNRA.shp")
```
