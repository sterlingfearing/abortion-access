...
```{r}
# weight gestational limit

adjustIndex <- read_csv(here("code/data/lawIndex.csv"))

adjustIndex$gestational <- adjustIndex$gestational*2

# create new summ column
...
write_csv(newSumm, here("code/data/lawIndexRoe.csv"))
```
